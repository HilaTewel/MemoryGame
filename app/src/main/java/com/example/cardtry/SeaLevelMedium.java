...
public class SeaLevelMedium extends Level {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        customType(SeaLevelMedium.this,"fadein-to-fadeout");
        levelTime = 60000;
        numOfLives = 15;
        levelName = "SeaMedium";
        ...
        context = SeaLevelMedium.this;
        thisLevel = SeaLevelMedium.class;
        nextLevel = SeaLevelHard.class;
        NUM_OF_CARDS = 16;
        ...
        //pictures array
        pictures[0] =R.drawable.ship;
        pictures[1]=R.drawable.seastar;
        pictures[2]=R.drawable.seahorse;
        pictures[3]= R.drawable.seaweed;
        pictures[4]= R.drawable.fishyellow;
        pictures[5]= R.drawable.bottle;
        pictures[6]= R.drawable.coral;
        pictures[7]= R.drawable.fishgroup;
