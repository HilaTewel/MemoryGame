...
public class AnimalsLevelMedium extends Level {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        customType(AnimalsLevelMedium.this,"fadein-to-fadeout");
        levelTime = 60000;
        numOfLives = 15;
        levelName = "AnimalsMedium";
        cardBack = R.drawable.animals_card_back;
        sp = getSharedPreferences("details", MODE_PRIVATE);
        coins = sp.getInt("coins", 1000);
        isPassed = sp.getBoolean(levelName, false);
        context = AnimalsLevelMedium.this;
        thisLevel = AnimalsLevelMedium.class;
        nextLevel= AnimalsLevelHard.class;
        NUM_OF_CARDS = 16;
