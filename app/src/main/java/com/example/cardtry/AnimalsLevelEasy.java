...
public class AnimalsLevelEasy extends Level {
    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.easy_board);
        customType(AnimalsLevelEasy.this,"fadein-to-fadeout");
        levelTime = 60000;
        numOfLives = 10;
        levelName = "AnimalsEasy";
        cardBack = R.drawable.animals_card_back;
        sp = getSharedPreferences("details", MODE_PRIVATE);
        coins = sp.getInt("coins", 1000);
        isPassed = sp.getBoolean(levelName, false);
        context = AnimalsLevelEasy.this;
        thisLevel = AnimalsLevelEasy.class;
        nextLevel = AnimalsLevelMedium.class;
        NUM_OF_CARDS = 12;
