...
public class SeaLevelHard extends Level {
    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.hard_board);
        customType(SeaLevelHard.this,"fadein-to-fadeout");
        levelTime = 90000;
        numOfLives = 40;
        levelName = "SeaHard";
        ...
        context = SeaLevelHard.this;
        thisLevel = SeaLevelHard.class;
        nextLevel = SpaceLevelEasy.class;
        NUM_OF_CARDS = 30;
        ...
        //pictures array
        pictures[0] =R.drawable.seaweed;
        pictures[1]=R.drawable.bottle;
        pictures[2]=R.drawable.ship;
        pictures[3]= R.drawable.coral;
        pictures[4]= R.drawable.fishgroup;
        pictures[5]= R.drawable.fishyellow;
        pictures[6]= R.drawable.seahorse;
        pictures[7]= R.drawable.seastar;
        pictures[8]= R.drawable.seagull;
        pictures[9]= R.drawable.seasnake;
        pictures[10]= R.drawable.lifewheel;
        pictures[11]= R.drawable.steerwheel;
        pictures[12]= R.drawable.compass;
        pictures[13]= R.drawable.claim;
        pictures[14]= R.drawable.anchor;
