...
public class SpaceLevelHard extends Level {
    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.hard_board);
        customType(SpaceLevelHard.this,"fadein-to-fadeout");
        levelTime = 90000;
        numOfLives = 40;
        levelName = "SpaceHard";
        ...
        context = SpaceLevelHard.this;
        thisLevel = SpaceLevelHard.class;
        nextLevel = MainActivity.class;
        NUM_OF_CARDS = 30;
        ...
        //pictures array
        pictures[0] =R.drawable.astroid;
        pictures[1]=R.drawable.astronaut;
        pictures[2]=R.drawable.star2;
        pictures[3]= R.drawable.star1;
        pictures[4]= R.drawable.redstar;
        pictures[5]= R.drawable.fallingstar;
        pictures[6]= R.drawable.spaceship2;
        pictures[7]= R.drawable.spaceship;
        pictures[8]= R.drawable.earth;
        pictures[9]= R.drawable.sun;
        pictures[10]= R.drawable.mars;
        pictures[11]= R.drawable.solarsystem;
        pictures[12]= R.drawable.blackhole;
        pictures[13]= R.drawable.halfmoon;
        pictures[14]= R.drawable.meteor;
